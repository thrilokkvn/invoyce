...
import markAsPaid from "@/actions/mark-as-paid";
...
export default async function UpdateInvoice({params} : {params : Promise<{invoiceId: string}>}) {
            ...
            <Card className="w-full max-w-2xl">
                <CardHeader className="text-center space-y-4 pb-6">
                    ...
                    <CardDescription className="text-lg text-gray-600 max-w-md mx-auto">
                        Are you sure you want to Update invoice{" "}
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-sm text-yellow-800">
                        <strong>Warning:</strong> This action cannot be undone. The invoice will be marked as paid permanently.
                    </div>
                </CardHeader>
                ...
                <CardFooter className="flex justify-between items-center pt-6">
                    ...
                    <form action={async() => {
                        ...
                        <SubmitButton text="Mark as Paid" loadingText="Updating..."/>
                    </form>
                </CardFooter>
            </Card>        
        </div>
